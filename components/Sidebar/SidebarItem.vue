<template>
  <li
    :class="`relative flex items-center py-2 px-3 my-1 font-medium rounded-md cursor-pointer transition-colors group ${active ? 'bg-gradient-to-tr from-red-200 to-red-100 text-red-800' : 'hover:bg-red-50 text-gray-600'}`">
    <icon />
