  ...
  <aside class="h-screen">
    <nav class="h-full flex flex-col bg-white border-r">
      <div class="p-4 pb-2 flex justify-between items-center">
        <img :src="logoSrc" :class="`overflow-hidden transition-all ${expanded ? 'w-32' : 'w-0'
          }`" alt="logo" :width="dimension" :height="dimension" />
        <button @click="toggleExpanded" class="p-1.5 rounded-lg bg-gray-50 hover:bg-gray-100">
